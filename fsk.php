...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Detail Gambar Surat Keluar #<?= $h['no_suratkeluar'] ?></h6>
    </div>

    <div class="card-body text-center">
        <img src="file/suratkeluar/<?=$h['file_suratkeluar']?>" class="img-fluid" alt="Responsive image" style="border:1px solid #ddd">
    </div>
</div>
