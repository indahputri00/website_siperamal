<?php
    ...
    if($_GET['act']== 'tambah'){
        ...
        if($cek>0){
            ...
            //query tambah
            $querytambah =  mysqli_query($conn, "INSERT INTO tb_disposisi VALUES(NULL , '$tujuan' , '$tgldisp', '$isi' , '$sifat', '$catatan', '$idsm')");
    ...
    elseif($_GET['act']=='edit'){
        ...
        //query edit
        $queryedit = mysqli_query($conn, "UPDATE tb_disposisi SET tujuan='$tujuan' , tgl_disposisi='$tgldisp', isi_disposisi='$isi' , sifat='$sifat', catatan='$catatan' WHERE id_disposisi='$id' ");
