...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Detail Gambar Surat Masuk #<?= $h['no_suratmasuk'] ?></h6>
    </div>

    <div class="card-body text-center">
        <img src="file/suratmasuk/<?=$h['file_suratmasuk']?>" class="img-fluid" alt="Responsive image" style="border:1px solid #ddd;"/>
    </div>
</div>
