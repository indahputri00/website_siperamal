...
<div class="alert alert-dark">Note * Setelah mengedit data Anda akan otomatis keluar dan harus login lagi</div>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Edit Profile Pengguna</h6>
    </div>
	...
	<form action="data/data_profil.php?act=edit" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-footer text-right">
            ...
            <button class="btn btn-success" type="submit" name="edit"><i class="fas fa-fw fa-check mr-1"></i> Simpan</button>
        </div>
    </form>
</div>
