...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-building"></i> Data Instansi</h1>
</div>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Daftar Data Instansi</h6>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
				<table class="table table-bordered">
					<tr>
						<th class="bg-light">Nama Bagian</th>
						<td><?= $row['nama'] ?></td>
					</tr>
    ...
    <div class="card-footer text-right">
        <a href="#" data-toggle="modal" data-target="#editdata" class="btn btn-dark"> <i class="fa fa-edit"></i> Edit Data </a>
    </div>
</div>
        ...
        <div class="modal-content">
			...
			?>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success" name="edit" type="submit"><i class="fas fa-fw fa-check mr-1"></i> Update</button>
                </div>
            </form>
        </div>
    </div>
